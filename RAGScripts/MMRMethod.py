...
configuration = "MMR_{}_{}_{}".format(_chunkSize, _chunkOverlap, _chunkNumber)
...
#----------------------4. Retrieve ----------------------------------
retriever = vectorstore.as_retriever(search_type="mmr", search_kwargs={ "k": _chunkNumber, "lambda_mult": 0.5})
