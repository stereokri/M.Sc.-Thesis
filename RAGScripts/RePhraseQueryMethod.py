...
configuration = "RePhraseQuery{}_{}_{}".format(_chunkSize, _chunkOverlap, _chunkNumber)
...
rephrased_question = Utils.rephrase_question(question)
formatted_context = Utils.format_docs(retriever.invoke(rephrased_question))
