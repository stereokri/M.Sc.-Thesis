...
configuration = "HyDE{}_{}_{}".format(_chunkSize, _chunkOverlap, _chunkNumber)
...
hyde = Utils.generate_hypothetical_answer(question)
formatted_context = Utils.format_docs(retriever.invoke(hyde))
